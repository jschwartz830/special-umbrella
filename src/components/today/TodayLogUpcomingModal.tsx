import { Info, CheckCircle2, SkipForward, Coffee } from 'lucide-react'
...
export function TodayLogUpcomingModal({ rd, error, onLog, onClose }: Props) {
  const title = new Date(rd.calendarDate + 'T00:00').toLocaleDateString('en-US', {
    weekday: 'long',
    month: 'long',
    day: 'numeric',
  })
