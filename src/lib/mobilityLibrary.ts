...
export const MOBILITY_LIBRARY: MobilityLibraryExercise[] = [
  ...
  },
  {
    ...
    categories: ['scapula-shoulder'],
    durationSec: 100,
    description: 'Elbow tucked at side, bent 90°. Press forearm outward into a wall or immovable hand resistance without moving the arm. Hold 5 sec, 10 reps, 2 sets per side. Builds rotator cuff (infraspinatus/teres minor) strength pain-free.',
    bilateral: true,
  },
  {
    ...
    categories: ['scapula-shoulder'],
    durationSec: 100,
    description: 'Elbow tucked at side, bent 90°. Press forearm inward into a wall or immovable hand resistance without moving the arm. Hold 5 sec, 10 reps, 2 sets per side. Builds rotator cuff (subscapularis) strength pain-free.',
    bilateral: true,
  },
  {
    ...
    categories: ['scapula-shoulder'],
    durationSec: 100,
    description: 'Arm elevated to about 90° (shoulder height), elbow bent 90°. Press forearm outward into resistance without moving the arm. Hold 5 sec, 10 reps, 2 sets per side. Same cuff activation as the standard version, trained at a more functional overhead angle.',
  ...
  {
    id: 'lib-band-bilateral-horizontal-abduction',
    name: 'Elastic Band Bilateral Horizontal Abduction',
    categories: ['scapula-shoulder', 'posture'],
    durationSec: 45,
    description: 'Hold an elastic band with elbows straight and arms in front of the body. Pull both arms apart and out to the sides under control.',
  },
  {
    id: 'lib-band-bilateral-shoulder-er',
    name: 'Elastic Band Shoulder External Rotation',
    categories: ['scapula-shoulder'],
    durationSec: 45,
    description: 'Hold an elastic band with both elbows bent and tucked at the sides. Start with hands near the stomach, then pull the band apart while keeping both elbows at the sides.',
  },
  {
